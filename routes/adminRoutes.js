...
const { getAllSubscriptions, getVendorSubscriptionHistory, cancelSubscription } = require("../controllers/admin/subscriptionController");
...
router.get("/num-of-society", authenticate, authorizeRoles("admin"), numofSociety);
...
router.put("/services/update-prices", authenticate, authorizeRoles("admin"), updateServicePrices);
